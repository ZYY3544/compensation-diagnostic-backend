...
STANDARD_LEVEL_DEFINITIONS = {
    'Level 1': '手工操作人员 — 流水线作业操作，完成已确定工序的日常工作，受直接监督',
    'Level 2': '一般职员 — 行政及辅助功能岗位，如人事助理、财务助理、前台等',
    'Level 3': '专业技术人员 — 独立贡献者，不具备人员管理职责，在某一专业领域有广泛知识和技能',
    'Level 4': '主管/高级专业技术人员 — 负责次级部门或团队的日常管理、考核绩效；或为他人提供专业指导',
    'Level 5': '部门经理（中级管理人员）— 第一线管理人员，管理一个主要部门的活动，制定部门目标和工作程序',
    'Level 6': '高级经理 — 对某一业务部门或主要职能部门的短期和长期经营决策起重要作用',
    'Level 7': '总监 — 公司最高负责人层级，制定和诠释公司层面政策，组织跨业务部门项目',
}
